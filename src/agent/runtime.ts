    ...
    try {
      ...
      if (this.toolRegistry) {
        ...
        const MODULE_LABELS: Record<string, string> = {
          ...
          ton: "⛓️ TON Blockchain — Wallet balance, send TON/jettons, transactions, jetton info, NFTs, charts",
          telegram:
            "📱 Telegram — Send messages, photos, GIFs, stickers, voice, polls, reactions, dice",
          fragment:
            "🏪 Fragment — Username sniper, valuation, market intel, deals, portfolio, OTC matchmaker, gift collections, marketplace aggregator",
          gift: "🎁 Gift Market — Floor prices, price history, sales data, user inventory, portfolio valuation",
          ...
          deals: "🤝 OTC Deals — Propose deals, verify payments, track deal status",
          ...
          file: "📄 File Ops — Read, write, edit files in workspace",
          browser: "🌐 Browser — Screenshot pages, extract content",
          cron: "⏰ Reminders — Set reminders, schedule recurring messages",
          subagent: "🤖 Sub-agents — Spawn parallel tasks",
          pdf: "📕 PDF — Analyze PDF documents",
          summarize: "📋 Summarize — Summarize URLs and text",
        };
