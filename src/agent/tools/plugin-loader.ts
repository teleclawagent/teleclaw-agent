/**
 * Enhanced plugin loader — discovers and loads external plugins from ~/.teleclaw/plugins/
 *
...
import type {
  ...
  PluginMessageEvent,
  PluginCallbackEvent,
} from "@teleclaw-agent/sdk";
import { createLogger } from "../../utils/logger.js";

const log = createLogger("PluginLoader");

const PLUGIN_DATA_DIR = join(TELECLAW_ROOT, "plugins", "data");
