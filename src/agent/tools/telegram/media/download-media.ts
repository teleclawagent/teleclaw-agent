...
export const telegramDownloadMediaTool: Tool = {
  ...
  description:
    "Fetch media (photo, video, voice, sticker, document, GIF) from a message and save it to ~/.teleclaw/downloads/. Returns the local file path. Pair with vision_analyze or telegram_send_photo to process or forward downloaded files.",
