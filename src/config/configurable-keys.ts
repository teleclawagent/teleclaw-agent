...
export const CONFIGURABLE_KEYS: Record<string, ConfigKeyMeta> = {
  ...
  // ─── Deals / OTC Matchmaker ─────────────────────────────────────────
  "deals.enabled": {
    type: "boolean",
    category: "Deals",
    label: "OTC Matchmaker Enabled",
    description: "Enable the OTC matchmaker module (matchmaker-only, no escrow)",
    sensitive: false,
    hotReload: "instant",
    validate: enumValidator(["true", "false"]),
    mask: identity,
  ...
  "dev.hot_reload": {
    ...
    category: "Developer",
    label: "Hot Reload",
    description: "Watch ~/.teleclaw/plugins/ for live changes",
    sensitive: false,
    hotReload: "instant",
    validate: enumValidator(["true", "false"]),
    mask: identity,
