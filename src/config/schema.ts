...
export const TelegramConfigSchema = z.object({
  ...
  bot_username: z
    .string()
    .optional()
    .describe("Bot username without @ (e.g., 'teleclaw_deals_bot')"),
});

export const StorageConfigSchema = z.object({
  sessions_file: z.string().default("~/.teleclaw/sessions.json"),
  memory_file: z.string().default("~/.teleclaw/memory.json"),
...
export const MetaConfigSchema = z.object({
  ...
  onboard_command: z.string().default("teleclaw setup"),
});
...
const _DevObject = z.object({
  hot_reload: z
    .boolean()
    .default(false)
    .describe("Enable plugin hot-reload (watches ~/.teleclaw/plugins/ for changes)"),
});
